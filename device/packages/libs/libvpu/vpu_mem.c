...
void *mem_test_loop_0(void *pdata)
{
    ...
    printf("vpu_mem test 0 loop start\n");
    memset(m, 0, sizeof(m));
...
int test_0()
{
    ...
    if (err) {
        printf("main  : found vpu mem operation err %d\n", err);
    } else {
...
void *mem_test_loop_1(void *pdata)
{
    ...
    printf("vpu_mem test 1 loop start\n");
    memset(m, 0, sizeof(m));
    //for (i = 0; i < LOOP_MEM; i++) {
    for (i = 0; ; i++) {
