...
typedef struct glsDATABASE_CONTAINER
{
...
glsDATABASE_CONTAINER;

typedef struct glsDATABASE
{
    /* Owner of the database. */
    glsDATABASE_CONTAINER *         owner;
    GLFramebuffer                   fbOwner;
...
gceSTATUS glshPlayDatabase(IN GLContext Context,
