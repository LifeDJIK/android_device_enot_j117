    ...
    )
{
    ...
    else
    {
        ...
        glmBATCH(context, return, glmBATCH_NOP, (glshBatchSync(context, gcvTRUE)));
    }
#endif
    ...
    )
{
    ...
    glmENTER2(glmARGENUM, shadertype, glmARGENUM, precisiontype)
	{
	...
	glmLEAVE3(glmARGINT, range[0], glmARGINT, range[1], glmARGINT, *precision);
}
