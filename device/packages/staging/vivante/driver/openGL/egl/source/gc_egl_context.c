...
static const char * _dlls[][2] =
{
    ...
    /* OpenGL ES 3.0 */             {"libGLESv3.so",               LIB_PATH "libGLESv3_" TAG ".so"},
...
static const char * _dlls[][2] =
{
    ...
    /* OpenGL ES 3.0 */             {"glesv3-dlls",  gcvNULL},
...
static const char * _dlls[][2] =
{
    ...
    /* OpenGL ES 3.0 */             {"libGLESv3",      gcvNULL},
    /* OpenVG 1.0 */                {"libOpenVG",      gcvNULL},
};
#endif
...
static const char * _dispatchNames[] =
{
    ...
    /* OpenGL ES 3.0             */ "GLESv3_DISPATCH_TABLE",
    ...
    )
{
    ...
    do
    {
        ...
        case EGL_OPENGL_ES_API:
            index = vegl_OPENGL_ES11 + client - 1;
            break;
    ...
    )
{
    ...
    if (Context->dispatch == gcvNULL)
    {
        ...
        case EGL_OPENGL_ES_API:
#ifndef VIVANTE_NO_3D
            Context->dispatch = esDispatchTables[Context->client];
#else
            Context->dispatch = gcvNULL;
#endif /* VIVANTE_NO_3D */
            break;
                  ...
                  )
{
    ...
    return (*dispatch->createContext)(Os, Hal, SharedContext, config);
}
...
#if __VIV_GLES3_HALTI__
EGLBoolean
_ApiMakeCurrent(VEGLThreadData Thread,
                VEGLContext    Context,
                VEGLDrawable   Draw,
                VEGLDrawable   Read)
{
    ...
    return (*dispatch->makeCurrent)(ApiContext, (void*)Draw, (void*)Read);
}

gceSTATUS
_SetDrawable(VEGLThreadData Thread,
             VEGLContext    Context,
             VEGLDrawable   Draw,
             VEGLDrawable   Read)
{
    ...
    return (*dispatch->setDrawable)(ApiContext, (void*)Draw, (void*)Read);
}
    ...
    )
{
    ...
    if (thread->api == EGL_OPENGL_ES_API)
    {
        ...
        EGLenum renderableType = ((VEGLConfig)config)->renderableType;
        ...
        case 3:
            valid = (renderableType & EGL_OPENGL_ES3_BIT) ? EGL_TRUE : EGL_FALSE;
            break;
        }
    ...
    if (sharedContext != gcvNULL)
    {
        ...
        if (((sharedContext->thread != gcvNULL) && (sharedContext->thread != thread))
    ...
    )
{
    ...
    )
    {
        ...
        if (thread->context != EGL_NO_CONTEXT)
        {
            ...
            /* Remove context. */
#if __VIV_GLES3_HALTI__
            gcmVERIFY(_ApiMakeCurrent(thread, thread->context, gcvNULL, gcvNULL));
#else
            gcmVERIFY(
