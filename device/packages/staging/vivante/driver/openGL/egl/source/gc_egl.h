...
/* Halti driver defined __GLdrawablePrivate must have same layout */
typedef struct EGLDrawableRec
{
    ...
    void * stencilHanlde;   /* gco surface handle of stencil */
...
struct eglSurface
{
    ...
    gcoSURF                     fbWrappers[3];	/* Support Triple Buffer at most. */
