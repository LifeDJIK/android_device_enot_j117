    ...
    )
{
    ...
    ALOGW("Dpy=0x%x configs=0x%x config_size=%d\n",
                  Dpy, configs, config_size);
    ...
    )
{
    ...
    if (thread == gcvNULL)
    {
        ...
        ALOGW("---> %s: veglGetThreadData failed <---\n", __func__);
    ...
    if (!veglParseAttributes(dpy, attrib_list, &criteria))
    {
        ...
        ALOGW("---> %s: invalid or non-matching attributes <---\n", __func__);
        gcmFOOTER_ARG("return=%d", EGL_FALSE);
        return EGL_FALSE;
    }
    ...
    if (!veglReferenceDisplay(thread, dpy))
    {
        /* Not initialized. */
        thread->error = EGL_NOT_INITIALIZED;
        ALOGW("---> %s: display not initialized <---\n", __func__);
        gcmFOOTER_ARG("return=%d", EGL_FALSE);
        return EGL_FALSE;
    }
    ...
    *num_config = 0;
    ...
    for (config = 0; config < dpy->configCount; config++)
    {
        ...
        if (criteria.bufferSize > configuration->bufferSize)
        {
            ...
            ALOGW("---> %s: rejected on buffer size <---\n", __func__);
            continue;
        }
        ...
        if (criteria.alphaSize > configuration->alphaSize)
        {
            ...
            ALOGW("---> %s: rejected on alpha size <---\n", __func__);
            continue;
        }
        ...
        if (criteria.greenSize > configuration->greenSize)
        {
            ...
            ALOGW("---> %s: rejected on green size <---\n", __func__);
            continue;
        }
        ...
        if (criteria.depthSize > configuration->depthSize)
        {
            ...
            ALOGW("---> %s: rejected on depth size <---\n", __func__);
            continue;
        }
        ...
        if (criteria.stencilSize > configuration->stencilSize)
        {
            ...
            ALOGW("---> %s: rejected on stencil size <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on config caveat <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on native renderable <---\n", __func__);
            continue;
        }
            ...
            (criteria.nativeVisualType != configuration->nativeVisualType))
        {
            ...
            ALOGW("---> %s: rejected on native visual type <---\n", __func__);
            continue;
        }
        ...
        if (criteria.sampleBuffers > configuration->sampleBuffers)
        {
            ...
            ALOGW("---> %s: rejected on sample buffers <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on surface type <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on bind to tetxure RGB <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on bind to tetxure RGBA <---\n", __func__);
            continue;
        }
        ...
        if (criteria.luminanceSize > configuration->luminanceSize)
        {
            ...
            ALOGW("---> %s: rejected on luminance size <---\n", __func__);
            continue;
        }
        ...
        if (criteria.alphaMaskSize > configuration->alphaMaskSize)
        {
            ...
            ALOGW("---> %s: rejected on  alpha mask size <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on color buffer type <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on renderable type <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on conformant <---\n", __func__);
            continue;
        }
        ...
        )
        {
            ...
            )
            {
                ...
                ALOGW("---> %s: rejected on match native pixmap <---\n", __func__);
                continue;
            }
            ...
            if (!bMatch)
            {
                ...
                gcmTRACE_ZONE(gcvLEVEL_INFO, gcdZONE_EGL_CONFIG,
                              "  rejected on match native pixmap.");
                ALOGW("---> %s: rejected on match native pixmap (2) <---\n", __func__);
                continue;
            }
        }
        ...
        )
        {
            ...
            if (!bMatch)
            {
                ...
                gcmTRACE_ZONE(gcvLEVEL_INFO, gcdZONE_EGL_CONFIG,
                              "  rejected on conformant.");
                ALOGW("---> %s: rejected on conformant (2) <---\n", __func__);
                continue;
            }
        }
        ...
        )
        {
            ...
            ALOGW("---> %s: rejected on recordable config <---\n", __func__);
            continue;
        }
    ...
    ALOGW("${EGL eglChooseConfig 0x%08X (0x%08X) (0x%08X) 0x%08X "
                "(0x%08X)\n",
                Dpy, attrib_list, configs, config_size, num_config);
