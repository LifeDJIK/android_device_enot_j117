...
typedef struct _glsTEXTUREWRAPPER
{
	...
	/* This texture may be scaled to 16 pixel alignment to meet resolve
	 * limation. This is the scale factor from aligned value to origin. */
	GLfloat                 uscale;
