    ...
    do {
        ...
        if (UseMask)
        {
            ...
            if (!UseSource)
            {
                ...
                gcmASSERT(mParms->mSrcSurf.mSize <= mParms->mSrcBuffer->mSize);
                mParms->mSrcSurf.mVirtualAddr = mParms->mSrcBuffer->mVirtualAddr;
                mParms->mSrcSurf.mPhysicalAddr = mParms->mSrcBuffer->mPhysicalAddr;
                mParms->mSrcSurf.mDMAAddr = mParms->mSrcBuffer->mDMAAddr;
