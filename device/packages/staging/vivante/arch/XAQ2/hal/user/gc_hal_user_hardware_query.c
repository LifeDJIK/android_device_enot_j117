    ...
    )
{
    ...
    case gcvSURF_TEXTURE:
        ...
        case gcvSURF_DXT5:
            ...
            ((((gctUINT32) (hardware->chipMinorFeatures3)) >> (0 ? 5:5) & ((gctUINT32) ((((1 ? 5:5) - (0 ? 5:5) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 5:5) - (0 ? 5:5) + 1)))))) == (0x1 & ((gctUINT32) ((((1 ? 5:5) - (0 ? 5:5) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 5:5) - (0 ? 5:5) + 1)))))));
            break;
        default:
            superTiled = gcvFALSE;
        }
    ...
    )
{
    ...
    case gcvSURF_DEPTH_NO_TILE_STATUS:
        ...
        if (((Type == gcvSURF_RENDER_TARGET_NO_TILE_STATUS) || (Type == gcvSURF_DEPTH_NO_TILE_STATUS))
            && ((hardware->chipModel == gcv880) || (hardware->chipModel == gcv860) || (hardware->chipModel == gcv1000)))
        {
            xAlignment = 16;
    ...
    )
{
    ...
    gcmHEADER_ARG("Type=%d Format=0x%x HAlignment=0x%x VAlignment=0x%x",
                  Type, Format, HAlignment, VAlignment);
	...
	)
{
	...
	if (MaxIndex != gcvNULL)
	{
        ...
        if (((((gctUINT32) (hardware->chipFeatures)) >> (0 ? 31:31) & ((gctUINT32) ((((1 ? 31:31) - (0 ? 31:31) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 31:31) - (0 ? 31:31) + 1)))))) == (0x1 & ((gctUINT32) ((((1 ? 31:31) - (0 ? 31:31) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 31:31) - (0 ? 31:31) + 1))))))))
        {
            if ((hardware->chipRevision > 0x5000 && hardware->chipRevision < 0x5100)
            || (hardware->chipRevision > 0x4000 && hardware->chipRevision < 0x4600))
            {
	...
	)
{
	...
	if (Varyings != gcvNULL)
	{
        ...
        *Varyings = hardware->varyingsCount;
	}
    ...
    )
{
    ...
    case gcvFEATURE_HZ:
        available = ((((gctUINT32) (hardware->chipMinorFeatures)) >> (0 ? 27:27) & ((gctUINT32) ((((1 ? 27:27) - (0 ? 27:27) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 27:27) - (0 ? 27:27) + 1)))))) == (0x1  & ((gctUINT32) ((((1 ? 27:27) - (0 ? 27:27) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 27:27) - (0 ? 27:27) + 1)))))));
         ...
         if (gcoOS_DetectProcessByName("com.aurorasoftworks.quadrant")
         && (hardware->chipModel == gcv2000 && hardware->chipRevision == 0x5108)
         )
         {
             available = gcvFALSE;
    ...
    case gcvFEATURE_TEX_COMPRRESSION_SUPERTILED:
        available = ((((gctUINT32) (hardware->chipMinorFeatures3)) >> (0 ? 5:5) & ((gctUINT32) ((((1 ? 5:5) - (0 ? 5:5) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 5:5) - (0 ? 5:5) + 1)))))) == (0x1  & ((gctUINT32) ((((1 ? 5:5) - (0 ? 5:5) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 5:5) - (0 ? 5:5) + 1)))))));
        break;
    ...
    case gcvFEATURE_RS_YUV_TARGET:
        available = ((((gctUINT32) (hardware->chipFeatures)) >> (0 ? 30:30) & ((gctUINT32) ((((1 ? 30:30) - (0 ? 30:30) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 30:30) - (0 ? 30:30) + 1)))))) == (0x1  & ((gctUINT32) ((((1 ? 30:30) - (0 ? 30:30) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 30:30) - (0 ? 30:30) + 1)))))));
        break;

    case gcvFEATURE_PE_DITHER_FIX:
        available = gcvFALSE;
        break;

    case gcvFEATURE_BUG_FIXED_INDEXED_TRIANGLE_STRIP:
        available = gcvFALSE;
        break;
#endif
