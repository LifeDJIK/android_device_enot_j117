    ...
    )
{
    ...
    /* 4 bits/pixel. */
    sourceStride = Width * BytesPerTile / 16;
    targetStride = gcmALIGN(Width, 64) * BytesPerTile / 16;

    source = (gctUINT32_PTR) Source;

    for (y = 0; y < Height; y+=4)
    {
        rowOffset = (y & ~63) * targetStride;
        source = (gctUINT32_PTR)((gctUINT32) Source + y * sourceStride);
        ...
        for (x = 0; x < Width; x+=4)
        {
            ...
            gcmVERIFY_OK(gcoOS_MemCopy(
                (gctPOINTER)((gctUINT32)Target + offset),
                source,
                BytesPerTile));
    ...
    )
{
    ...
    gcmHEADER_ARG("TargetInfo=%d Logical=0x%x "
                  "Offset=%u Width=%u Height=%u "
                  "ImageSize=%u",
                  TargetInfo, Logical,
				  Offset, Width, Height,
                  ImageSize);
    ...
    )
{
    ...
    halti1Avail = ((((gctUINT32) (Hardware->chipMinorFeatures2)) >> (0 ? 11:11) & ((gctUINT32) ((((1 ? 11:11) - (0 ? 11:11) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 11:11) - (0 ? 11:11) + 1)))))) == (0x1  & ((gctUINT32) ((((1 ? 11:11) - (0 ? 11:11) + 1) == 32) ? ~0 : (~(~0 << ((1 ? 11:11) - (0 ? 11:11) + 1)))))));
