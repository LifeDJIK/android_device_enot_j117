...
protected:
	gckOS			m_Os;
	gckKERNEL		m_Kernels[gcdGPU_COUNT];
...
protected:
	DWORD		m_MemBases[gcdGPU_COUNT];
#ifndef EMULATOR
	gctUINT8 *	m_RegisterBases[gcdGPU_COUNT];
...
protected:
	DWORD  m_InterruptIDs[gcdGPU_COUNT];
	HANDLE m_InterruptEvents[gcdGPU_COUNT];
	HANDLE m_InterruptThreads[gcdGPU_COUNT];
#ifdef EMULATOR
	HANDLE m_WaitEvent;
