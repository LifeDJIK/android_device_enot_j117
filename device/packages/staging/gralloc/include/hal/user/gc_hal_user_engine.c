    ...
    )
{
    ...
    status = gcoHARDWARE_SetDepthPlaneF(Near, Far);
    ...
    )
{
	...
	/* Route to hardware. */
	status = gcoHARDWARE_SetWClipEnable(Enable);
    ...
    )
{
	...
	/* Route to hardware. */
	status = gcoHARDWARE_SetWPlaneLimit(gcvNULL, Value);
    ...
    )
{
	...
	/* Route to hardware. */
	status = gcoHARDWARE_SetWPlaneLimit(gcvNULL, Value / 65536.0f);
