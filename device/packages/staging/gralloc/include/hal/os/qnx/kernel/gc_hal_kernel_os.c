    ...
    )
{
    ...
    *Atom = atom;
    ...
    /* Success. */
    gcmkFOOTER_ARG("*Atom=0x%0x Value=0x%0x", *Atom, *atom);
    return gcvSTATUS_OK;
...
{
    gceSTATUS status;
    gctSIZE_T pageCount, pageShift, pageMask;
