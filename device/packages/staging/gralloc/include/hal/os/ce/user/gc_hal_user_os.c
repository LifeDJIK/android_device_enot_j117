    ...
    )
{
    ...
    value = InterlockedIncrement((volatile LONG *) &Atom->counter) - 1;
    ...
    )
{
    ...
    value = InterlockedDecrement((volatile LONG *) &Atom->counter) + 1;
...
{
    /* Unimplemented. See linux implementation. */
