...
/*
    ENABLE_FILTER_STRETCH

        Enable it to use filter blit for stretching.
        By default stretch blit is used. Filter blit is slower than stretch
        but has better visual quality.
*/
#define ENABLE_FILTER_STRETCH 0
